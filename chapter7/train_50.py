...
NUM_MUTUAL_PRODUCTS = 3
DYNAMIC_CONTROL = 'minus'
PREF_CONST = 1.50

MAX_TRAINING_STEPS = 5*10**6
...
if __name__ == '__main__':
    ...
    env = TradingSession(action_space_config = 'discrete', num_mutual_sessions = NUM_MUTUAL_PRODUCTS, dyn_control = DYNAMIC_CONTROL, pref_const = PREF_CONST)
